	...
	return (
		...
		>
			<div className="bg-white p-8 rounded-2xl shadow-md max-w-md w-full">
				...
				<h1 className="text-2xl font-semibold text-gray-800 mb-2">Ops! Produto não encontrado</h1>
				<p className="text-gray-600 mb-6">
					Não conseguimos encontrar o produto que você está procurando. Talvez ele tenha sido
					removido ou nunca existiu.
				</p>
